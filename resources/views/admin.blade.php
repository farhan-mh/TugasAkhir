  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/usr" target="_blank" class="nav-link">Home</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="" role="" data-accordion="">
          ...
          <li class="nav-item d-none">
            ...
            <!-- <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('editHalaman') }}" class="nav-link ">
                  <!-- <i class="far fa-circle nav-icon"></i> -->
          ...
          <li class="nav-item">
            <a href="/post" class="nav-link {{  Request::is('active') ? 'post' : ''  }}">
          ...
          <li class="nav-header">EXAMPLESss</li>
          <li class="nav-item">
